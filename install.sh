...
git clone https://github.com/krry/kamadhenu/ "$BREWFIX/kamadhenu" || printf
"Cloning the git repository has gone awry." && exit 1

cd "$BREWFIX/kamadhenu" || printf "Oops, flubbed the dismount.\nFind 'kamadhenu' in %s and type 'brew bundle' to continue.\n" "$BREWFIX" && exit 1
